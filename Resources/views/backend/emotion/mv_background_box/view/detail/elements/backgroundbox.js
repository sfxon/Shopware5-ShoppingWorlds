...
//{$smarty.block.parent}
Ext.define('Shopware.apps.Emotion.view.detail.elements.Backgroundbox', {
     ...
     */
    alias: 'widget.detail-element-emotion-components-backgroundbox',

    /**
     * You can define an additional CSS class which will be used for the grid element.
     */
    componentCls: 'emotion--background-box',
     ...
     */
        ...
        var me = this,
            preview = '',
            image = me.getConfigValue('backgroundbox_thumbnail'),
            style;
