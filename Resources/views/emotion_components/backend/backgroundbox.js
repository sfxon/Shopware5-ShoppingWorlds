// {namespace name="backend/emotion/background_box_element"}
//{block name="emotion_components/backend/backgroundbox_backgroundbox"}
Ext.define('Shopware.apps.Emotion.view.components.Backgroundbox', {
     ...
     */
    alias: 'widget.emotion-components-backgroundbox',
